                                ...
                                onPressed: () async {
                                  ...
                                  if (_con.creditCard.validated()) {
                                    try {
                                      ...
                                      var onSuccess = () {
                                        var details = {'subtotal': _con.subTotal, 'delivery_fee': _con.deliveryFee, 'tax': _con.carts[0].food.restaurant.defaultTax, 'tax_amount': _con.taxAmount, 'total': _con.total};
                                      ...
                                      var onUnavailableForPickup = () => _con.scaffoldKey?.currentState?.showSnackBar(SnackBar(content: Text('The restaurant is not available for pickup')));
                                      ...
                                      await _con.addOrder(paymentMethod, onAuthenticationFailed, onSuccess, onError, onRestaurantNotAvailable, onUnavailableForDelivery, onUnavailableForPickup, onFoodOutOfStock, onValidationError);
                                    }
